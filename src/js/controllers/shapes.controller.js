(function () {
    ...
    app.controller("ShapesCtrl", function (RadialGradientsService, ColorsService) {
        const $ctrl = this;
        ...
        this.changeGradient = function () {
            ...
            $ctrl.gradient = RadialGradientsService.createShapesGradient(firstColorRGB, secondColorRGB);
