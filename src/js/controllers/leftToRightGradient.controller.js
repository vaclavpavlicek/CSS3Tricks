(function () {
    ...
    app.controller("LeftToRightGradientCtrl", function (LinearGradientsService, ColorsService) {
        const $ctrl = this;
        ...
        this.changeGradient = function () {
            ...
            $ctrl.gradient = LinearGradientsService.createLeftToRightGradient(firstColorRGB, secondColorRGB);
